...
def find_proper_divisors(n):
	...
	if n==1: return []
		...
		while i <= n/i: 
			if n % i == 0: 
				divisors.append(i)
				if i != n/i: divisors.append(n/i) #Do not duplicate squares
			i+=1
		return divisors
...
def find_type(n):
	...
	number_type = ""
	if summation < n: number_type = "deficient"
	elif summation == n: number_type = "perfect"
	elif summation > n: number_type = "abundant"
	return 	number_type
